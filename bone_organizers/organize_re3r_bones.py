...
class OBJECT_OT_organize_re3r_bones(bpy.types.Operator):
    bl_idname = "object.organize_re3r_bones"
    bl_label = "Organize RE3R Bones"
    bl_description = "Organizes RE3R armature bones based on Blender version (Layers for 3.x, Collections for 4.x)"
    ...
    def execute(self, context):
        ...
        primary_bones = [
            "head", "neck 1", "neck 0", "spine 2", "spine 1", "spine 0", "hips",
            "l leg femur", "l leg tibia", "l leg ankle", "l leg ball",
            "l arm clavicle", "l arm humerus", "l arm radius", "l arm wrist",
            "r leg femur", "r leg tibia", "r leg ankle", "r leg ball",
            "r arm clavicle", "r arm humerus", "r arm radius", "r arm wrist"
        ]

        finger_bones = [
            "l hand thumb 0", "l hand thumb 1", "l hand thumb 2",
            "l hand index 0", "l hand index 1", "l hand index 2",
            "l hand middle 0", "l hand middle 1", "l hand middle 2",
            "l hand ring 1", "l hand ring 2", "l hand ring 3",
            "l hand little 1", "l hand little 2", "l hand little 3",
            "r hand thumb 0", "r hand thumb 1", "r hand thumb 2",
            "r hand index 0", "r hand index 1", "r hand index 2",
            "r hand middle 0", "r hand middle 1", "r hand middle 2",
            "r hand ring 1", "r hand ring 2", "r hand ring 3",
            "r hand little 1", "r hand little 2", "r hand little 3"
        ]
        ...
        self.report({'INFO'}, "RE3R Bones organized successfully!")
        return {'FINISHED'}
