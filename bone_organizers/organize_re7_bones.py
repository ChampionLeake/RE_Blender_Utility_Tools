...
class OBJECT_OT_organize_re7_bones(bpy.types.Operator):
    bl_idname = "object.organize_re7_bones"
    bl_label = "Organize RE7 Bones"
    bl_description = "Organizes RE7 armature bones based on Blender version (Layers for 3.x, Collections for 4.x)"
