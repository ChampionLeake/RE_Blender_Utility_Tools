...
class OBJECT_OT_organize_re8_bones(bpy.types.Operator):
    bl_idname = "object.organize_re8_bones"
    bl_label = "Organize RE8 Bones"
    bl_description = "Organizes RE Village armature bones based on Blender version (Layers for 3.x, Collections for 4.x)"
