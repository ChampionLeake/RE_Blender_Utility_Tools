...
class OBJECT_OT_organize_dmc5_bones(bpy.types.Operator):
    bl_idname = "object.organize_dmc5_bones"
    bl_label = "Organize DMC5 Bones"
    bl_description = "Organizes DMC5 armature bones based on Blender version (Layers for 3.x, Collections for 4.x)"
    ...
    def execute(self, context):
        ...
        primary_bones = [
            "Head", "Neck", "Chest", "Stomach", "Waist", "Hip",
        ...
        self.report({'INFO'}, "RE Village Bones organized successfully!")
        return {'FINISHED'}
