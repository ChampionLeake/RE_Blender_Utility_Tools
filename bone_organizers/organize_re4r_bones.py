...
class OBJECT_OT_organize_re4r_bones(bpy.types.Operator):
    bl_idname = "object.organize_re4r_bones"
    bl_label = "Organize RE4R Bones"
    bl_description = "Organizes RE4R armature bones based on Blender version (Layers for 3.x, Collections for 4.x)"
