...
class OBJECT_OT_rename_mixamo_bones_to_re7(bpy.types.Operator):
    bl_idname = "object.rename_mixamo_bones_to_re7"
    bl_label = "Rename Bones (Mixamo to RE7)"
    bl_description = "Renames commonly used Mixamo bones to RE7's naming conventions"
