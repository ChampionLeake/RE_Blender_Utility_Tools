...
class OBJECT_OT_rename_xnalara_bones_to_mhwilds(bpy.types.Operator):
    bl_idname = "object.rename_xnalara_bones_to_mhwilds"
    bl_label = "Rename Bones (Xnalara to MH Wilds)"
    bl_description = "Renames commonly used Xnalara bones to MH Wilds's naming conventions"
