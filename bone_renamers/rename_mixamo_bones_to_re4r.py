...
class OBJECT_OT_rename_mixamo_bones_to_re4r(bpy.types.Operator):
    bl_idname = "object.rename_mixamo_bones_to_re4r"
    bl_label = "Rename Bones (Mixamo to RE4R)"
    bl_description = "Renames commonly used Mixamo bones to RE4R's naming conventions"
