...
class OBJECT_OT_rename_mmd_bones_to_re7(bpy.types.Operator):
    bl_idname = "object.rename_mmd_bones_to_re7"
    bl_label = "Rename Bones (MMD to RE7)"
    bl_description = "Renames commonly used MMD bones to RE7's naming conventions"
