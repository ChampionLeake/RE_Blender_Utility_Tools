...
class OBJECT_OT_rename_xnalara_bones_to_re4r(bpy.types.Operator):
    bl_idname = "object.rename_xnalara_bones_to_re4r"
    bl_label = "Rename Bones (Xnalara to RE4R)"
    bl_description = "Renames commonly used Xnalara bones to RE4R's naming conventions"
