...
class OBJECT_OT_rename_mixamo_bones_to_re8(bpy.types.Operator):
    bl_idname = "object.rename_mixamo_bones_to_re8"
    bl_label = "Rename Bones (Mixamo to RE8)"
    bl_description = "Renames commonly used Mixamo bones to RE8's naming conventions"
