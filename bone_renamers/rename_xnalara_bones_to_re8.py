...
class OBJECT_OT_rename_xnalara_bones_to_re8(bpy.types.Operator):
    bl_idname = "object.rename_xnalara_bones_to_re8"
    bl_label = "Rename Bones (Xnalara to RE8)"
    bl_description = "Renames commonly used Xnalara bones to RE8's naming conventions"
