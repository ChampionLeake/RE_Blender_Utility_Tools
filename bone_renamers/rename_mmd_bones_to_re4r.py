...
class OBJECT_OT_rename_mmd_bones_to_re4r(bpy.types.Operator):
    bl_idname = "object.rename_mmd_bones_to_re4r"
    bl_label = "Rename Bones (MMD to RE4R)"
    bl_description = "Renames commonly used MMD bones to RE4R's naming conventions"
