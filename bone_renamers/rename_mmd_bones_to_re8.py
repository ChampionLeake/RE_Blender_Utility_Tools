...
class OBJECT_OT_rename_mmd_bones_to_re8(bpy.types.Operator):
    bl_idname = "object.rename_mmd_bones_to_re8"
    bl_label = "Rename Bones (MMD to RE8)"
    bl_description = "Renames commonly used MMD bones to RE8's naming conventions"
