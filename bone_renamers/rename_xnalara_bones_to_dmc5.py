...
class OBJECT_OT_rename_xnalara_bones_to_dmc5(bpy.types.Operator):
    bl_idname = "object.rename_xnalara_bones_to_dmc5"
    bl_label = "Rename Bones (Xnalara to DMC5)"
    bl_description = "Renames commonly used Xnalara bones to DMC5's naming conventions"
