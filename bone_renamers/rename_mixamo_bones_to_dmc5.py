...
class OBJECT_OT_rename_mixamo_bones_to_dmc5(bpy.types.Operator):
    bl_idname = "object.rename_mixamo_bones_to_dmc5"
    bl_label = "Rename Bones (Mixamo to DMC5)"
    bl_description = "Renames commonly used Mixamo bones to DMC5's naming conventions"
