...
class SetMaterialBlendBase(bpy.types.Operator):
    ...
    blend_mode = 'HASHED'  # Override this in subclasses
...
class OBJECT_OT_set_blend_hashed(SetMaterialBlendBase):
    bl_idname = "object.set_blend_hashed"
    bl_label = "Set Alpha Hashed"
    blend_mode = 'HASHED'